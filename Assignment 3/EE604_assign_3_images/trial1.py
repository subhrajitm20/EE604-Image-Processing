...
img = cv2.imread("Assignment 3/EE604_assign_3_images/noisy1.JPG", cv2.IMREAD_COLOR)
...
image = cv2.imread("Assignment 3/EE604_assign_3_images/noisy1.JPG", cv2.IMREAD_COLOR)
filtered_image_OpenCV = cv2.bilateralFilter(image, 7, 20.0, 20.0)
cv2.imwrite("filtered_image_OpenCV.JPG", filtered_image_OpenCV)
image_own = bilateral_filter(image, 7, 20.0, 20.0)
cv2.imwrite("filtered_image_own.JPG", image_own)